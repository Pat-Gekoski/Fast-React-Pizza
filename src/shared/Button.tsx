...
function Button({ children, disabled, to, type, onClick }: PropsWithChildren<any>) {
	const base =
	...
	if (onClick) {
		return (
			<button onClick={onClick} disabled={disabled} className={styles[type as 'primary' | 'small']}>
				{children}
			</button>
		)
	}
